        ...
        <div
            ...
            <form action="{{ route('projects.store') }}" method="POST">
                ...
                <div class="flex items-start w-full justify-between pt-4 rounded-t">
                    <h3 class="text-base text-black font-bold "> Edit Skills </h3>
                </div>
                <!--body-->
                <div class="relative  flex-auto">
                    ...
                    <textarea
                        class="appearance-none resize-none bg-gray-200 text-sm font-normal outline-none rounded-xl overflow-hidden px-3 py-2 leading-[2.15] w-full h-[10rem] @error('description') border-2 border-red-500 @enderror"
                ...
                <div class="flex items-center justify-end p-4">
                    <button
                        ...
                        type="button" onclick="toggleModal('modal-idSkillsEditPanels')">
                        Close
                    </button>
                    <button
...
<div class="hidden opacity-25 fixed inset-0 z-40 bg-black" id="modal-idSkillsEditPanels-backdrop"></div>
