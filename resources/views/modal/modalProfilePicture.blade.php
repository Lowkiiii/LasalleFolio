        ...
        <div
            ...
            <div class="flex items-center justify-end p-4" >
                <button
                    ...
                    type="button" onclick="toggleModal('modal-idProfilePicture')">
                    Close
                </button>
                <button
                    class="bg-[#006634] text-white active:bg-emerald-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                    type="button" onclick="toggleModal('modal-idProfilePicture')">
                    Save Changes
                </button>
            </div>
...
<div class="hidden opacity-25 fixed inset-0 z-40 bg-black" id="modal-idProfilePicture-backdrop"></div>
