        ...
        <div
            ...
            <form action="{{ route('honorsandawards.store') }}" method="POST">
                ...
                <div class="flex items-start w-full justify-between pt-4 rounded-t">
                    <h3 class="text-md text-black font-bold "> Edit Awards and Honors </h3>
                </div>
                <!--body-->
                <div class="relative pb-5 flex-auto">
                    <p class=" mx-2 leading-relaxed">
                    <div class="text-sm text-black font-semibold pb-2 pt-5">Edit Title</div>
                    <input type="text"
                    ...
                    <p class=" mx-2 leading-relaxed">
                    <div class="text-sm text-black font-semibold pb-2 pt-5">Description</div>
                    <textarea
                ...
                <div class="flex items-center justify-end p-4">
                    <button
                        ...
                        type="button" onclick="toggleModal('modal-idEditAwardsHonorsPanel')">
                        Close
                    </button>
                    <button
...
<div class="hidden opacity-25 fixed inset-0 z-40 bg-black" id="modal-idEditAwardsHonorsPanel-backdrop"></div>
