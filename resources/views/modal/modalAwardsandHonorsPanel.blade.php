        ...
        <div
            ...
            <form action="{{ route('honorsandawards.store') }}" method="POST">
                ...
                <div class="flex items-start w-full justify-between pt-4 rounded-t">
                    <h3 class="text-base text-black font-bold "> Add Honors and Awards </h3>
                </div>
                <!--body-->
                <div class="relative  flex-auto">
                    ...
                    <div class="flex flex-row justify-start items-start rounded-xl py-2">
                        ...
                        <div class="text-xs flex-col flex font-semibold items-start justify-start truncate text-black px-1 w-full mt-auto mb-auto  ">Date Issued
                        <input type="date"
                            ...
                            id="" name="date_issue" placeholder="Date Issued" />
                        @error('date_issue')
                            <span class="text-red-500">{{ $message }}</span>
                        @enderror
