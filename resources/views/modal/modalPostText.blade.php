        ...
        <div
            ...
            <form action="{{ route('posts.store') }}"
                ...
                <div class="relative pb-5 flex-auto">
                    ...
                    <!-- Image upload field -->
                    <div class="flex flex-row rounded-lg bg-gray-200 w-full items-center text-[#006634] font-bold text-lg mt-6">
                        ...
                        <input type="file"
                               ...
                               class="hidden">
                        <label for="image"
                               class="cursor-pointer text-sm bg-[#006634] text-white px-4 py-2 rounded-l-lg  hover:bg-[#004423] focus:outline-none">Upload
                            an Image</label>
                        <span id="fileName"
                              class="bg-gray-200 text-black font-normal px-1"></span>
                        @error('image')
                            <span class="text-red-500">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="text-sm text-black pb-2 pt-1">
                    ...
                    <div id="customCategoryDiv"
                        ...
                        <label for="customCategory"
                               class="block font-bold">Enter Custom Category:</label>
                        <input type="text"
                               id="customCategory"
...
<div class="hidden opacity-25 fixed inset-0 z-40 bg-black"
     id="modal-idPostText-backdrop"></div>
