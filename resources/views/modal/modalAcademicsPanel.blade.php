            ...
            <form action="{{ route('academics.store') }}" method="POST">
                ...
                <div class="flex items-center justify-end p-4">
                    <button
                        ...
                        type="button" onclick="toggleModal('modal-idAcademics')">
                        Close
                    </button>
                    <button
...
<div class="hidden opacity-25 fixed inset-0 z-40 bg-black" id="modal-idAcademics-backdrop"></div>