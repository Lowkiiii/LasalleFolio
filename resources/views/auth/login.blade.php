...
<section class="h-screen bg-white">
  ...
  <div class="absolute mx-auto max-y-md max-w-lg flex items-center">
    ...
    @if ($errors->any())
        <div class=" top-0 w-full mt-4">
            @foreach ($errors->all() as $error)
                ...
                <div class=" animate-fadeIn mb-3 inline-flex w-full items-center justify-center rounded-lg border-danger border bg-danger-100 px-6 py-1 text-base text-danger-700 transition-opacity ease-in duration-700 opacity-100" role="alert">     
                <span class="mr-2">
    ...
    <div class="z-20 overflow-hidden flex flex-col items-center justify-center w-1/2">
      ...
      <div class="inline-block rounded-xl bg-opacity-10  px-8 pt-6 pb-8 mb-4 sm:w-3/5 ">
        ...
        <form  method="POST" action="{{ route('login') }}">
          ...
          <div class="mb-6 flex items-center justify-between">
            ...
            <a href="#!" class="text-black hover:text-[#006634] font-semibold transition ease-in-out duration-150">Forgot password?</a>
          </div>
          ...
          <button
            ...
            <p class="text-TextGray mb-0 mt-10 pt-1 text-sm text-center">
              ...
              <a
                href="/register"
                class="transition duration-150 ease-in-out focus:text-danger-600 active:text-danger-700 underline font-semibold text-black hover:text-[#006634]"
                >Register now</a
              >
            </p>
          </div>
      ...
      <div class="flex bg-cover w-1/2 mx-auto hidden md:flex" style="background-image: url('/image/loginPIC.png'); background-repeat: no-repeat">
