                    ...
                    <div class="mb-6 flex items-center justify-between ">
                        ...
                        <div class="items-center justify-center  pl-[1.5rem]"
                            ...
                            <label
                                ...
                                I agree to the <button type="button" onclick="toggleModal('modal-idTerms')" class="text-blue-500 px-1 underline"
