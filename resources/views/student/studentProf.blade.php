                                        ...
                                        <div class="absolute right-0 top-0 z-20">
                                            <button class="p-4" >
                                                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15"
                                                    ...
                                                    <path
                                                        d=" M7.127 22.562l-7.127 1.438 1.438-7.128 5.689
                        ...
                        <div class="w-full relative flex flex-wrap items-start space-x-3 mr-10 py-[1.8rem] px-2 border border-[#939393] rounded-lg  shadow-lg"
                            ...
                            <div class="absolute right-0 top-0 z-20">
                                <button class="p-4" onclick="toggleModal('modal-idProjects')">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15"
                                        viewBox="0 0 24 24" class="fill-current text-[#6e6e6e] hover:text-[#006634]">
                                        <path
                                            d="M7.127 22.562l-7.127 1.438 1.438-7.128 5.689 5.69zm1.414-1.414l11.228-11.225-5.69-5.692-11.227 11.227 5.689 5.69zm9.768-21.148l-2.816 2.817 5.691 5.691 2.816-2.819-5.691-5.689z" />
                                    </svg>
                                </button>
                                    ...
                                    <div class="text-xl font-bold  opacity-70">
                                        <button class="p-4 fill-current text-[#6e6e6e] hover:text-[#006634]"
                                            ...
                                            <svg enable-background="new 0 0 512 512" height="18px" id="Layer_1"
                                                version="1.1" viewBox="0 0 512 512" width="18px" xml:space="preserve" onclick="toggleModal('modal-idProjects')"
        ...
        <div class="flex flex-col w-full mr-1">
            ...
            <div class="container mx-auto">
                ...
                @forelse ($userProjects as $project)
                    <div class="w-full relative flex flex-wrap items-start space-x-3 mr-10 py-[1.8rem] px-2 border border-[#939393] rounded-lg shadow-lg mb-4">
                        <div class="absolute right-0 top-0 z-20">
                            <button class="p-4 fill-current text-[#6e6e6e] hover:text-[#006634]" onclick="toggleModal('modal-idPanels')">
                                <!-- SVG code for the edit button -->
                            </button>
                        </div>
                        <div class="relative">
                            <div class="relative py-2 text-xl font-bold text-[#006634]">
                                <div class="text-black">{{ $project->project }}</div>
                            </div>
                                ...
                                <div class="flex items-center pb-1">
                                    ...
                                    <div class="ml-3 py-3 text-xs font-medium text-black">
                                        <div class="font-bold text-sm">
                                            {{ $project->description }}
                                            <button class="px-1" onclick="toggleModal('modal-idProjects')">
                                                <!-- SVG code for the edit button -->
                                            </button>
                                        </div>
                                        <p>Start Date: {{ \Carbon\Carbon::parse($project->date_started)->format('F d, Y') }}</p>
                                        <p>End Date: {{ $project->date_ended ? \Carbon\Carbon::parse($project->date_ended)->format('F d, Y') : 'Not set' }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
