                            ...
                            <div class="w-full">
                                <div class="p-4 grid grid-cols-3 gap-4">
                                    <div class="col-span-3 flex justify-between items-center">
                                        <button id="prev"
                                                type="button"
                                                class="p-3 rounded-xl {{ $users->onFirstPage() ? 'pointer-events-none text-white bg-[#A3C8B8]' : 'text-white bg-[#006634]' }}">
                                        ...
                                        <button id="next"
                                                type="button"
                                                class="px-6 py-3 rounded-xl {{ $users->hasMorePages() ? 'text-white bg-[#006634]' : 'text-white bg-[#A3C8B8] pointer-events-none' }}">
