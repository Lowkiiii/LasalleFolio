            ...
            <div class="flex">
                ...
                <div class="flex flex-row">
                    <div class="relative flex " >
                        <button type="button"  class="flex flex-col items-center mx-auto mr-8 " id="viewLeaderBoard">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#939393" class="w-6 h-6">
                                <path fill-rule="evenodd" fill="{{ request()->routeIs('student.studentLeaderboard') ? '#006634' : '#939393' }}"
                    ...
                    <div class="relative flex">
                        ...
                        <div id="menu"
                            class="absolute bg-white space-x-3 p-1 border border-[#D4D4D4] rounded-lg shadow-lg w-55  transform translate-y-full hidden bottom-[-.5rem] left-1/2 -translate-x-1/2 z-30">
