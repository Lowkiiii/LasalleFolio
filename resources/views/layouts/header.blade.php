                ...
                <div class="flex flex-row">
                    ...
                    @if($friendRequests->count() > 0)
                        <button id="friendRequestButton" class="relative">
                            ...
                            <!-- Notification badge -->
                            <div class="absolute">
                            <div class="relative transform -translate-x-10 -translate-y-5 top-0 right-0 inline-flex items-center justify-center w-5 h-5 text-xs font-bold leading-none text-red-100 bg-red-600 rounded-full">{{ $friendRequests->count() }}</div>
                        </div>
                        </button>
