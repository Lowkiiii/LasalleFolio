...
<body class="bg-gray-100">
    ...
    <div class=" mt-20 py-12">
        <div class="top-8 max-w-3xl mx-auto px-4">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="border rounded-lg p-6 bg-white">
                            ...
                            @php
                                ...
                                $descriptions = [
                                    'data_engineering' =>
                                        'You show a strong aptitude for building and maintaining data infrastructure. Data Engineers design and construct data pipelines, ensure data quality, and optimize data systems.',
                                    'data_science' =>
                                        'Your responses indicate strength in analytical thinking and statistical analysis. Data Scientists extract insights from data, build predictive models, and solve complex business problems.',
                                    'ai_engineering' =>
                                        'You demonstrate interest in machine learning and AI systems. AI Engineers develop intelligent systems, implement neural networks, and create cutting-edge AI solutions.',
                                ];
                            @endphp
