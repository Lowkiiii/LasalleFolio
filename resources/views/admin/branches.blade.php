...
<div class="border-b-2 px-10 flex flex-row items-center justify-between bg-[#313f6a]"> 
    ...
    <div class="flex flex-row justify-start">
        ...
        <div class="m-7 ">
            <h2 class="text-3xl font-bold mb-7">Branch Profile</h2>
            <div class="w-full flex justify-end ">
                <a href="/admin-addbranch" class="bg-[#7bafed] hover:bg-[#010c2a] transition ease-in-out duration-150 p-2 rounded-md mb-7 text-white"><strong>+</strong> Add New Branch</a>
            </div>
                ...
                class="min-w-full text-sm font-light dark:border-neutral-500 bg-[#010e3b]">
                    <thead class="font-medium text-black dark:border-neutral-500">
                        <tr>
                            <th
                                scope="col"
                                class=" text-left dark:border-neutral-500 pb-3.5 pl-4 text-white">
                                NAME
                            </th>
                            <th
                                scope="col"
                                class=" text-left dark:border-neutral-500 pb-3.5 text-white">
                                CODE
                            </th>
                            <th scope="col" class="text-left dark:border-neutral-500 pb-3.5 text-white">COUNTRY CODE</th>
                            <th scope="col" class="text-left dark:border-neutral-500 pb-3.5 text-white">CURRENCY</th>
                            <th scope="col" class="text-left dark:border-neutral-500 pb-3.5 text-white" colspan="2">ACTION</th>
                        </tr>
                    </thead>
                        ...
                        @foreach ($branch as $cont)
                            <tr class="border-t border-b border-neutral-300 ease-in-out hover:bg-neutral-100">
                                ...
                                <td
                                    ...
                                    <form action="{{ route('admin.deletebranch',$cont->id) }}" method="GET" onsubmit="return confirm('{{ trans('Are you sure you want to delete this ? ') }}');">
                                        @csrf
